//To read the information of a square from a mld file.
package read_mld;
...
public class readSquare {
	...
	private static byte[] inOutb2 = new byte[32];
	...
	//To print the coordinates (x,y) of the origin of the square, in millimeters.
	...
	//To print the 8-byte-double (width/2) / (height/2) of the square, in millimeters. 
	public static void readWidth_Height() {
		long l;
	    l=inOutb2[16];
	    l&=0xff;
	    l|=((long)inOutb2[17]<<8);
		...
		System.out.println("Width_Height: "+ Double.longBitsToDouble(l));
	}
	
	//To print the 8-byte-double angle of the square, in millimeters.
