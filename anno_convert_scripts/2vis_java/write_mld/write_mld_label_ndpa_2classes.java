//To write annotation exacted from a ndpa file into a mld file as labels. 
package write_mld;
...
public class write_mld_label_ndpa_2classes {
	...
	public static void main(String argv[]) throws IOException {
		...
		String f = "W:\\HES HCC DL Projet\\HMNT0478_bis - 2017-06-05 09.59.58.ndpi.ndpa";		
		...
		try {
			...
			listByte = ByteList_add_an_int.op(nlabel, listByte);
