//To exact annotation named by its index, from ndpa files (xml format, created by ndpView).
package write_mld;
...
public class read_xml_n_2classes {
...
//				System.out.println("annotation id: " + eElement.getAttribute("id"));
				...
				//This script should be applied on the annotation named by their index.
				anno_type_char[temp] = eElement.getElementsByTagName("title").item(0).getTextContent().substring(0, 1);
...
//				System.out.println("title : " + anno_type_char[temp]);
...
//				System.out.println("displayname: " + anno_shape_char[temp]);
