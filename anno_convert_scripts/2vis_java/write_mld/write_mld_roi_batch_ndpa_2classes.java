...
public class write_mld_roi_batch_ndpa_2classes {
	
	public write_mld_roi_batch_ndpa_2classes() {}
	...
	public static void ops(String fin, int index) throws IOException {
		...
		File outFile = new File("W:\\HES HCC DL Projet\\annotation_vis\\test\\" + index + "_roi.mld");
