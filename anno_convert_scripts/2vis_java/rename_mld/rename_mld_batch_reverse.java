 ...
 * 					roi_2classes -> LayerData
 * 					LayerData -> roi_tum
 */

public class rename_mld_batch_reverse {

	static String newString1 = "LayerData";//新字符串,如果是去掉前缀后缀就留空，否则写上需要替换的字符串
	static String oldString1= "roi_2classes";//要被替换的字符串
	static String newString2 = "roi_tum";//新字符串,如果是去掉前缀后缀就留空，否则写上需要替换的字符串
	static String oldString2 = "LayerData";//要被替换的字符串
