...
# writeTIFF(label, paste(path,"\\prob_map_tum",".tiff",sep=""),bits.per.sample=16L)

#this function enable the setting of resolution
tiff("D:\\hhh.tiff", res = 13874.7503175)
plot(label) # Make plot
dev.off()
