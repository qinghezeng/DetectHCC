...
for(c in every_64)
{
  ...
  {
    r_63 = r+63
    if(prob[j+1] >= 0.95) { #set threshold of confidence to 0.8
      label[r:r_63,c:c_63] = 11/255
      j = j+2
    } else if(prob[j+1] >= 0.9) { #set threshold of confidence to 0.8
      label[r:r_63,c:c_63] = 10/255
      j = j+2
    } else if(prob[j+1] >= 0.85) { #set threshold of confidence to 0.8
      label[r:r_63,c:c_63] = 9/255
      j = j+2
    } else if(prob[j+1] >= 0.8) { #set threshold of confidence to 0.8
      label[r:r_63,c:c_63] = 8/255
      j = j+2
    } else if(prob[j+1] >= 0.75) {
      label[r:r_63,c:c_63] = 7/255
      j = j+2
    } else if(prob[j+1] >= 0.7) {
      label[r:r_63,c:c_63] = 6/255
      j = j+2
    } else if(prob[j+1] >= 0.65) {
      label[r:r_63,c:c_63] = 5/255
      j = j+2
    } else if(prob[j+1] >= 0.6) {
      label[r:r_63,c:c_63] = 4/255
      j = j+2
    } else if(prob[j+1] >= 0.55) {
      label[r:r_63,c:c_63] = 3/255
      j = j+2
    } else if(prob[j+1] >= 0.5) {
