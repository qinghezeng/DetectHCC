#RScript for Visiopharm APP
#Split the WSI into 512x512 tiles (numbered tif files) for building a 5x dataset for automatic detector.
...
################################################################################################
#EDIT path to save the 512x512 tiles
path_512="E:\\deeplearning\\data\\5x\\detector\\train\\HMNT0278_bis\\512_image_label"
################################################################################################
