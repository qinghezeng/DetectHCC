...
#
#Xception pretraiened on imagenet
#Only learning on dense layers (frozen base model)
#input shape minimum = 71x71x3 thus doesn't work on 64x64
...
base_model <- application_xception(include_top = FALSE, 
                                   weights = "imagenet",
                                   input_tensor = NULL, 
...
save_model_hdf5(model, "D:\\dl\\5x\\models\\best_model", 
                overwrite = TRUE,
