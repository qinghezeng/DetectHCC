...
Cluster01 <- "Cluster High" # Cluster Median, Cluster High, Cluster Low
...
cout <- sub("Cluster 01", Cluster01, cout)
cout <- sub("Cluster 02", Cluster02, cout)
cout <- sub("Cluster 03", Cluster03, cout)
...
if (alg == "km") {
  ...
  write.table(cout, file= paste(out_path, "\\sample_clusters_",datas,"_",trans,"_",alg, "_", dst,"_",ncluster_col,sreorder,".csv", sep = ""),
